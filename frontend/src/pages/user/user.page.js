...
const navigation = [
  { name: 'Account', href: '/Account/User', icon: UserIcon, current: true },
  { name: 'Orders', href: '/Account/Orders', icon: CalendarIcon, current: false },
  { name: 'Reviews', href: '/Account/Reviews', icon: ChatAlt2Icon, current: false },
  { name: 'Coupons', href: '/Account/Coupons', icon: CreditCardIcon, current: false },
